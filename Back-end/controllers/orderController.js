...
exports.sendEmail = async (req, res) => {
  ...
  try {
      ...
      const transporter = nodemailer.createTransport({
          ...
          auth: {
              user: "assiarazgui950@gmail.com", // Remplacez par votre adresse email
              pass:"pvqd umnf imdv cbun", // Utilisez un mot de passe d'application sécurisé
          },
      });

      // Configurer les options de l'e-mail
      const mailOptions = {
          from: "assiarazgui950@gmail.com", // L'expéditeur
